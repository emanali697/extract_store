...
def write_results_excel(stores: list[dict[str, Any]], output_path: str | Path, *, job_id: str = "") -> Path:
    ...
    for row in range(2, ws.max_row + 1):
        ...
        for column in range(1, ws.max_column + 1):
            ...
            cell.alignment = Alignment(horizontal="center" if column in {1, 4, 5, 6, 8, 9, 12, 13, 19} else "right", vertical="center", wrap_text=True)
            cell.border = BORDER
            if row % 2 == 0:
                cell.fill = ALT_FILL
